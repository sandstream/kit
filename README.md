...
- `kit monkey-test`: Role-based release gate for money-handling apps: stack/env/seed detection, Playwright desktop+mobile crawl, sandbox money flow, and security pack. See [docs/MONKEY_TEST.md](docs/MONKEY_TEST.md)
