...
export const OFFICIAL_PLUGINS: PluginMetadata[] = [
  ...
  },
  {
    ...
    install: "npm install sandstream-kit-plugin-cloudflare@0.2.2",
  },
  {
    name: "fly",
    ...
    install: "npm install sandstream-kit-plugin-fly@0.2.2",
  },
  {
    name: "github",
    ...
    install: "npm install sandstream-kit-plugin-github@0.2.2",
  },
  {
    name: "railway",
    ...
    adapter: "railway/deploy",
    kitVersion: ">=6.0.0",
    tags: ["deployment", "hosting", "kit-plugin", "official", "railway"],
    install: "npm install sandstream-kit-plugin-railway@0.1.2",
  },
  {
    name: "sentrux",
    ...
    install: "npm install sandstream-kit-plugin-sentrux@0.1.2",
  },
  {
    name: "sentry",
    description:
    ...
    install: "npm install sandstream-kit-plugin-sentry@0.2.2",
  },
  {
    name: "snyk",
    ...
    install: "npm install sandstream-kit-plugin-snyk@0.1.2",
  },
  {
    name: "stripe",
    description:
    ...
    install: "npm install sandstream-kit-plugin-stripe@0.2.2",
  },
  {
    name: "supabase",
    description:
    ...
    install: "npm install sandstream-kit-plugin-supabase@0.2.2",
  },
  {
    name: "vercel",
    description:
    ...
    install: "npm install sandstream-kit-plugin-vercel@0.2.2",
  },
  {
    name: "wiz",
    ...
    install: "npm install sandstream-kit-plugin-wiz@0.1.2",
  },
];
