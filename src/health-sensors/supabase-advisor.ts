      ...
      return [
        {
          ...
          status: "unknown",
          title:
            "Supabase advisor probe skipped: SUPABASE_ACCESS_TOKEN / SUPABASE_PROJECT_REF not both set",
      ...
      return [
        {
          ...
          source,
          status: "green",
          title: "Supabase: no ERROR-level security advisors",
        },
      ];
    }
    ...
    return [
      {
        ...
        detail:
          "review Supabase → Advisors; likely RLS-disabled / exposed-data lints — a code/policy fix",
        suggestedClass: "code",
      },
    ];
  },
