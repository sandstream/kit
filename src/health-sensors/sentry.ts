      ...
      return [
        {
          ...
          status: "unknown",
          title:
            "Sentry probe skipped: SENTRY_AUTH_TOKEN / SENTRY_ORG / SENTRY_PROJECT not all set",
      ...
      return [
        {
          ...
          source,
          status: "green",
          title: "Sentry: no new unresolved issues in 24h",
        },
      ];
    }
    ...
    return [
      {
        ...
        detail:
          "triage at the Sentry dashboard; may be a real regression or benign noise to filter",
        suggestedClass: "code",
      },
    ];
  },
